...
if not "%~2"=="" if /I not "%~2"=="OpenGLES3" if /I not "%~2"=="TextureReport" (
  echo Unknown option: %~2
  echo Use OpenGLES3, TextureReport, or leave the second argument empty for Vulkan.
  pause
  exit /b 2
)
if /I "%~2"=="TextureReport" (
  powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Build-On-Windows.ps1" -Depot "%~1" -TextureReport
) else if /I "%~2"=="OpenGLES3" (
